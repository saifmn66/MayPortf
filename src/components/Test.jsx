          ...
          <ol className="relative m-16 sm:ml-[16vw] text-gray-200 sm:text-gray-700 border-l border-gray-400">
            ...
            <li className="mb-20 ms-16">
              ...
              <li className="mb-20 ms-16">
                ...
                <h3 className="font-medium text-2xl leading-tight">Bachelor`s Degree in Graphic Design
                </h3>
                <p className="text-sm">Higher Institute of Fine Arts Sousse<br/>
                  <span className='text-[#c0fdab] sm:text-[#329a0f] font-semibold'>Since Sept. 2024</span></p>
            </li>
              </AnimatedListItem>
              ...
              <li className="mb-20 ms-16">
                ...
                <h3 className="font-medium text-2xl leading-tight">Bachelor`s Degree in Image Design Introduction
                </h3>
                <p className="text-sm">Higher Institute of Arts and Crafts Al Mahdiyah<br/>
                  <span className='text-[#c0fdab] sm:text-[#329a0f] font-semibold'>Sept. 2023 - May 2024</span></p>
            </li>
              </AnimatedListItem>
              ...
              <li className="mb-20 ms-16">
                ...
                <p className="text-sm">High school Ibno Roched Sousse With Art option <br/>
                 <span className='text-[#c0fdab] sm:text-[#329a0f] font-semibold'>Sept 2021 - Juin 2022</span></p>
                </li>
              </AnimatedListItem>
